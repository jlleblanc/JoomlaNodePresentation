	...
	jQuery(document).ready(function () {
		var log_chat_message = function  (message, type) {
			...
			if (type === 'system') {
				...
				li.addClass('label label-important');
			}
			...
			<div class="row-fluid">
				...
				<div id="content" class="<?php echo $span;?>">
					...
					<div class="container-fluid">
						<div id="chatroom" class="span12 well">
							<ul id="chat_log" class="unstyled">
							</ul>
						</div>

						<input type="text" name="chat_box" value="" id="chat_box" class="span12" placeholder="type to chat..." />
					</div>
